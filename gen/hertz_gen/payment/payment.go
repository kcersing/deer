...
type PayReq struct {
	OrderId     int64   `thrift:"orderId,1,optional" form:"orderId" json:"orderId,omitempty" query:"orderId"`
	OrderSn     string  `thrift:"orderSn,2,optional" form:"orderSn" json:"orderSn,omitempty" query:"orderSn"`
	Total       float64 `thrift:"total,3,optional" form:"total" json:"total,omitempty" query:"total"`
	OpenId      string  `thrift:"openId,4,optional" form:"openId" json:"openId,omitempty" query:"openId"`
	ProductName string  `thrift:"productName,6,optional" form:"productName" json:"productName,omitempty" query:"productName"`
}
...
var PayReq_OrderId_DEFAULT int64 = 0
...
var PayReq_ProductName_DEFAULT string = ""

func (p *PayReq) GetProductName() (v string) {
	if !p.IsSetProductName() {
		return PayReq_ProductName_DEFAULT
	}
...
func (p *PayReq) IsSetOrderId() bool {
	return p.OrderId != PayReq_OrderId_DEFAULT
}
...
func (p *PayReq) IsSetProductName() bool {
	return p.ProductName != PayReq_ProductName_DEFAULT
}
...
func (p *PayReq) ReadField6(iprot thrift.TProtocol) error {
...
func (p *PayReq) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetProductName() {
		if err = oprot.WriteFieldBegin("productName", thrift.STRING, 6); err != nil {
			goto WriteFieldBeginError
		}
