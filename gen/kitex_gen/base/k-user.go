...
func (p *User) FastReadField256(buf []byte) (int, error) {
	offset := 0
...
func (p *User) FastReadField257(buf []byte) (int, error) {
	offset := 0
...
func (p *User) fastWriteField17(buf []byte, w thrift.NocopyWriter) int {
	...
	if p.IsSetDepartmentName() {
		...
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, p.DepartmentName)
	}
	return offset
}
...
func (p *User) fastWriteField18(buf []byte, w thrift.NocopyWriter) int {
	...
	if p.IsSetPositionName() {
		...
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, p.PositionName)
	}
	return offset
}
...
func (p *User) fastWriteField256(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCreatedId() {
...
func (p *User) fastWriteField257(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *User) field17Length() int {
	...
	if p.IsSetDepartmentName() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.StringLengthNocopy(p.DepartmentName)
	}
	return l
}
...
func (p *User) field18Length() int {
	...
	if p.IsSetPositionName() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.StringLengthNocopy(p.PositionName)
	}
	return l
}
...
func (p *User) field256Length() int {
	l := 0
	if p.IsSetCreatedId() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.I64Length()
...
func (p *User) field257Length() int {
	l := 0
	if p.IsSetCreatedName() {
		l += thrift.Binary.FieldBeginLength()
...
func (p *Departments) FastReadField256(buf []byte) (int, error) {
	offset := 0
...
func (p *Departments) FastReadField257(buf []byte) (int, error) {
	offset := 0
...
func (p *Departments) fastWriteField256(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCreatedId() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 256)
		offset += thrift.Binary.WriteI64(buf[offset:], p.CreatedId)
...
func (p *Departments) fastWriteField257(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCreatedName() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 257)
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, p.CreatedName)
...
func (p *Departments) field256Length() int {
	l := 0
	if p.IsSetCreatedId() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.I64Length()
...
func (p *Departments) field257Length() int {
	l := 0
	if p.IsSetCreatedName() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.StringLengthNocopy(p.CreatedName)
...
func (p *Positions) FastReadField256(buf []byte) (int, error) {
	offset := 0
...
func (p *Positions) FastReadField257(buf []byte) (int, error) {
	offset := 0
...
func (p *Positions) fastWriteField256(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCreatedId() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 256)
		offset += thrift.Binary.WriteI64(buf[offset:], p.CreatedId)
...
func (p *Positions) fastWriteField257(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCreatedName() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 257)
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, p.CreatedName)
...
func (p *Positions) field256Length() int {
	l := 0
	if p.IsSetCreatedId() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.I64Length()
...
func (p *Positions) field257Length() int {
	l := 0
	if p.IsSetCreatedName() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.StringLengthNocopy(p.CreatedName)
