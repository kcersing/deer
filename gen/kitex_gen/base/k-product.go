...
func (p *Product) FastReadField19(buf []byte) (int, error) {
	offset := 0
...
func (p *Product) FastReadField15(buf []byte) (int, error) {
	offset := 0
...
func (p *Product) FastReadField22(buf []byte) (int, error) {
	offset := 0
...
func (p *Product) fastWriteField19(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCode() {
...
func (p *Product) fastWriteField15(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetItems() {
...
func (p *Product) fastWriteField22(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetItemsData() {
...
func (p *Product) field19Length() int {
	l := 0
	if p.IsSetCode() {
		l += thrift.Binary.FieldBeginLength()
...
func (p *Product) field15Length() int {
	l := 0
	if p.IsSetItems() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.ListBeginLength()
...
func (p *Product) field22Length() int {
	l := 0
	if p.IsSetItemsData() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.ListBeginLength()
...
func (p *Item) FastReadField13(buf []byte) (int, error) {
	offset := 0
...
func (p *Item) FastReadField20(buf []byte) (int, error) {
	offset := 0
...
func (p *Item) FastReadField21(buf []byte) (int, error) {
	offset := 0
...
func (p *Item) fastWriteField12(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetPrice() {
...
func (p *Item) fastWriteField13(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCode() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 13)
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, p.Code)
...
func (p *Item) fastWriteField20(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCreatedId() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 20)
		offset += thrift.Binary.WriteI64(buf[offset:], p.CreatedId)
...
func (p *Item) fastWriteField21(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetCreatedName() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 21)
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, p.CreatedName)
...
func (p *Attribute) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Attribute[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *Attribute) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *Attribute) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *Attribute) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *Attribute) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *Attribute) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetItme() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 1)
		offset += thrift.Binary.WriteI64(buf[offset:], p.Itme)
	}
	return offset
}

func (p *Attribute) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetAttributes() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.DOUBLE, 2)
		offset += thrift.Binary.WriteDouble(buf[offset:], p.Attributes)
	}
	return offset
}

func (p *Attribute) field1Length() int {
	l := 0
	if p.IsSetItme() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.I64Length()
...
func (p *Attribute) field2Length() int {
	l := 0
	if p.IsSetAttributes() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.DoubleLength()
