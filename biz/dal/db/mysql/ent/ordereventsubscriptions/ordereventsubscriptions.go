...
const (
	// Label holds the string label denoting the ordereventsubscriptions type in the database.
	Label = "order_event_subscriptions"
	...
	// Table holds the table name of the ordereventsubscriptions in the database.
	Table = "order_event_subscriptions"
)

// Columns holds all SQL columns for ordereventsubscriptions fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the OrderEventSubscriptions queries.
