...
const (
	// Label holds the string label denoting the smssentrecords type in the database.
	Label = "sms_sent_records"
...
// OrderOption defines the ordering options for the SmsSentRecords queries.
