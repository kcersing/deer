...
func (_q *UserLoginLogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *UserLoginLogQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *UserLoginLogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *UserLoginLogQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *UserLoginLogQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *UserLoginLogQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserLoginLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userloginlog.Table, userloginlog.Columns, sqlgraph.NewFieldSpec(userloginlog.FieldID, field.TypeInt64))
	_spec.From = _q.sql
