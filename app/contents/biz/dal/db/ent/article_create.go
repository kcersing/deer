...
func (_c *ArticleCreate) SetDelete(v int64) *ArticleCreate {
	_c.mutation.SetDelete(v)
	return _c
}

// SetNillableDelete sets the "delete" field if the given value is not nil.
func (_c *ArticleCreate) SetNillableDelete(v *int64) *ArticleCreate {
	if v != nil {
		_c.SetDelete(*v)
	}
	return _c
...
func (_c *ArticleCreate) SetCreatedID(v int64) *ArticleCreate {
	_c.mutation.SetCreatedID(v)
	return _c
}

// SetNillableCreatedID sets the "created_id" field if the given value is not nil.
func (_c *ArticleCreate) SetNillableCreatedID(v *int64) *ArticleCreate {
	if v != nil {
		_c.SetCreatedID(*v)
	}
	return _c
...
func (_c *ArticleCreate) SetStatus(v int64) *ArticleCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *ArticleCreate) SetNillableStatus(v *int64) *ArticleCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *ArticleCreate) SetTagID(v []int64) *ArticleCreate {
	_c.mutation.SetTagID(v)
	return _c
}

// SetPic sets the "pic" field.
func (_c *ArticleCreate) SetPic(v []string) *ArticleCreate {
...
func (_c *ArticleCreate) defaults() {
	...
	if _, ok := _c.mutation.Delete(); !ok {
		v := article.DefaultDelete
		_c.mutation.SetDelete(v)
	}
	if _, ok := _c.mutation.CreatedID(); !ok {
		v := article.DefaultCreatedID
		_c.mutation.SetCreatedID(v)
	}
