...
func (_c *APICreate) SetDelete(v int64) *APICreate {
	_c.mutation.SetDelete(v)
	return _c
}

// SetNillableDelete sets the "delete" field if the given value is not nil.
func (_c *APICreate) SetNillableDelete(v *int64) *APICreate {
	if v != nil {
		_c.SetDelete(*v)
	}
	return _c
...
func (_c *APICreate) SetCreatedID(v int64) *APICreate {
	_c.mutation.SetCreatedID(v)
	return _c
}

// SetNillableCreatedID sets the "created_id" field if the given value is not nil.
func (_c *APICreate) SetNillableCreatedID(v *int64) *APICreate {
	if v != nil {
		_c.SetCreatedID(*v)
	}
	return _c
