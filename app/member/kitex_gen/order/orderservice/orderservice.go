...
func (p *kClient) DeleteOrder(ctx context.Context, req *base.IDReq) (r *base.BaseResp, err error) {
...
func (p *kClient) CancelledOrder(ctx context.Context, req *order.CreateOrderReq) (r *base.BaseResp, err error) {
...
func (p *kClient) RefundOrder(ctx context.Context, req *order.RefundOrderReq) (r *base.BaseResp, err error) {
