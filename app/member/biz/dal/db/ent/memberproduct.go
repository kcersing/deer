...
func (_m *MemberProduct) assignValues(columns []string, values []any) error {
...
func (_m *MemberProduct) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryMembers queries the "members" edge of the MemberProduct entity.
func (_m *MemberProduct) QueryMembers() *MemberQuery {
	return NewMemberProductClient(_m.config).QueryMembers(_m)
}
...
func (_m *MemberProduct) Update() *MemberProductUpdateOne {
	return NewMemberProductClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the MemberProduct entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *MemberProduct) Unwrap() *MemberProduct {
...
func (_m *MemberProduct) String() string {
