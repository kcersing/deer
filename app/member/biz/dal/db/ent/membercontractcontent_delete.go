...
func (_d *MemberContractContentDelete) Where(ps ...predicate.MemberContractContent) *MemberContractContentDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *MemberContractContentDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *MemberContractContentDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *MemberContractContentDelete) sqlExec(ctx context.Context) (int, error) {
...
type MemberContractContentDeleteOne struct {
	_d *MemberContractContentDelete
}

// Where appends a list predicates to the MemberContractContentDelete builder.
func (_d *MemberContractContentDeleteOne) Where(ps ...predicate.MemberContractContent) *MemberContractContentDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *MemberContractContentDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *MemberContractContentDeleteOne) ExecX(ctx context.Context) {
