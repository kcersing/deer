...
func (_d *MemberProductDelete) Where(ps ...predicate.MemberProduct) *MemberProductDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *MemberProductDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *MemberProductDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *MemberProductDelete) sqlExec(ctx context.Context) (int, error) {
...
type MemberProductDeleteOne struct {
	_d *MemberProductDelete
}

// Where appends a list predicates to the MemberProductDelete builder.
func (_d *MemberProductDeleteOne) Where(ps ...predicate.MemberProduct) *MemberProductDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *MemberProductDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *MemberProductDeleteOne) ExecX(ctx context.Context) {
