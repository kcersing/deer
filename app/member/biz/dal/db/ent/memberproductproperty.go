...
func (_m *MemberProductProperty) assignValues(columns []string, values []any) error {
...
func (_m *MemberProductProperty) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryOwner queries the "owner" edge of the MemberProductProperty entity.
func (_m *MemberProductProperty) QueryOwner() *MemberProductQuery {
	return NewMemberProductPropertyClient(_m.config).QueryOwner(_m)
}
...
func (_m *MemberProductProperty) Update() *MemberProductPropertyUpdateOne {
	return NewMemberProductPropertyClient(_m.config).UpdateOne(_m)
}
...
func (_m *MemberProductProperty) Unwrap() *MemberProductProperty {
...
func (_m *MemberProductProperty) String() string {
