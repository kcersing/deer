...
func (_d *MemberContractDelete) Where(ps ...predicate.MemberContract) *MemberContractDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *MemberContractDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *MemberContractDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *MemberContractDelete) sqlExec(ctx context.Context) (int, error) {
...
type MemberContractDeleteOne struct {
	_d *MemberContractDelete
}

// Where appends a list predicates to the MemberContractDelete builder.
func (_d *MemberContractDeleteOne) Where(ps ...predicate.MemberContract) *MemberContractDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *MemberContractDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *MemberContractDeleteOne) ExecX(ctx context.Context) {
