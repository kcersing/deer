...
func OrderIDGT(v int64) predicate.MemberContract {
	return predicate.MemberContract(sql.FieldGT(FieldOrderID, v))
}

// OrderIDGTE applies the GTE predicate on the "order_id" field.
func OrderIDGTE(v int64) predicate.MemberContract {
	return predicate.MemberContract(sql.FieldGTE(FieldOrderID, v))
}

// OrderIDLT applies the LT predicate on the "order_id" field.
func OrderIDLT(v int64) predicate.MemberContract {
	return predicate.MemberContract(sql.FieldLT(FieldOrderID, v))
}

// OrderIDLTE applies the LTE predicate on the "order_id" field.
func OrderIDLTE(v int64) predicate.MemberContract {
	return predicate.MemberContract(sql.FieldLTE(FieldOrderID, v))
}
