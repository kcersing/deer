...
const (
	// Label holds the string label denoting the opportunities type in the database.
	Label = "opportunities"
	...
	FieldPeriod = "period"
	// FieldPredictionAmount holds the string denoting the prediction_amount field in the database.
	FieldPredictionAmount = "prediction_amount"
	// FieldPeriodAt holds the string denoting the period_at field in the database.
	FieldPeriodAt = "period_at"
	// FieldEndSalesAt holds the string denoting the end_sales_at field in the database.
	FieldEndSalesAt = "end_sales_at"
	// Table holds the table name of the opportunities in the database.
	Table = "crm_opportunities"
)

// Columns holds all SQL columns for opportunities fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the Opportunities queries.
...
// ByPredictionAmount orders the results by the prediction_amount field.
func ByPredictionAmount(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPredictionAmount, opts...).ToFunc()
}

// ByPeriodAt orders the results by the period_at field.
func ByPeriodAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPeriodAt, opts...).ToFunc()
}
