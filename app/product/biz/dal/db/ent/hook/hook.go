...
// The FieldsFunc type is an adapter to allow the use of ordinary
// function as Fields mutator.
type FieldsFunc func(context.Context, *ent.FieldsMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FieldsFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FieldsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FieldsMutation", m)
}
