...
func (_q *ProductQuery) QueryPropertys() *ProductPropertyQuery {
	query := (&ProductPropertyClient{config: _q.config}).Query()
...
func (_q *ProductQuery) Clone() *ProductQuery {
	...
	return &ProductQuery{
		...
		withPropertys: _q.withPropertys.Clone(),
...
func (_q *ProductQuery) WithPropertys(opts ...func(*ProductPropertyQuery)) *ProductQuery {
	query := (&ProductPropertyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withPropertys = query
	return _q
}
...
func (_q *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	...
	if query := _q.withPropertys; query != nil {
		if err := _q.loadPropertys(ctx, query, nodes,
...
func (_q *ProductQuery) loadPropertys(ctx context.Context, query *ProductPropertyQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductProperty)) error {
