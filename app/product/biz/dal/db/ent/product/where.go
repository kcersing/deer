...
func DescIsNil() predicate.Product {
	return predicate.Product(sql.FieldIsNull(FieldDesc))
}

// DescNotNil applies the NotNil predicate on the "desc" field.
func DescNotNil() predicate.Product {
	return predicate.Product(sql.FieldNotNull(FieldDesc))
}
...
func HasItemsWith(preds ...predicate.ProductItem) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		step := newItemsStep()
