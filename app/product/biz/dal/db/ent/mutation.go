...
// AddItemIDs adds the "items" edge to the ProductItem entity by ids.
...
// ClearItems clears the "items" edge to the ProductItem entity.
func (m *ProductMutation) ClearItems() {
	m.cleareditems = true
}

// ItemsCleared reports if the "items" edge to the ProductItem entity was cleared.
func (m *ProductMutation) ItemsCleared() bool {
	return m.cleareditems
}

// RemoveItemIDs removes the "items" edge to the ProductItem entity by IDs.
...
// RemovedItems returns the removed IDs of the "items" edge to the ProductItem entity.
...
func (m *ProductItemMutation) SetActiveAt(t time.Time) {
	m.active_at = &t
}

// ActiveAt returns the value of the "active_at" field in the mutation.
func (m *ProductItemMutation) ActiveAt() (r time.Time, exists bool) {
	v := m.active_at
	if v == nil {
		return
	}
...
// OldActiveAt returns the old "active_at" field's value of the ProductItem entity.
// If the ProductItem object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProductItemMutation) OldActiveAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProductItemMutation) ClearActiveAt() {
	m.active_at = nil
	m.clearedFields[productitem.FieldActiveAt] = struct{}{}
}

// ActiveAtCleared returns if the "active_at" field was cleared in this mutation.
func (m *ProductItemMutation) ActiveAtCleared() bool {
	_, ok := m.clearedFields[productitem.FieldActiveAt]
	return ok
}

// ResetActiveAt resets all changes to the "active_at" field.
func (m *ProductItemMutation) ResetActiveAt() {
	m.active_at = nil
	delete(m.clearedFields, productitem.FieldActiveAt)
}

// SetExpiredAt sets the "expired_at" field.
func (m *ProductItemMutation) SetExpiredAt(t time.Time) {
	m.expired_at = &t
}

// ExpiredAt returns the value of the "expired_at" field in the mutation.
func (m *ProductItemMutation) ExpiredAt() (r time.Time, exists bool) {
	v := m.expired_at
	if v == nil {
		return
	}
...
// OldExpiredAt returns the old "expired_at" field's value of the ProductItem entity.
// If the ProductItem object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProductItemMutation) OldExpiredAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProductItemMutation) ClearExpiredAt() {
	m.expired_at = nil
	m.clearedFields[productitem.FieldExpiredAt] = struct{}{}
}

// ExpiredAtCleared returns if the "expired_at" field was cleared in this mutation.
func (m *ProductItemMutation) ExpiredAtCleared() bool {
	_, ok := m.clearedFields[productitem.FieldExpiredAt]
	return ok
}

// ResetExpiredAt resets all changes to the "expired_at" field.
func (m *ProductItemMutation) ResetExpiredAt() {
	m.expired_at = nil
	delete(m.clearedFields, productitem.FieldExpiredAt)
}
...
func (m *ProductItemMutation) AddProductIDs(ids ...int64) {
	if m.product == nil {
...
func (m *ProductItemMutation) RemoveProductIDs(ids ...int64) {
...
func (m *ProductItemMutation) RemovedProductIDs() (ids []int64) {
...
func (m *ProductItemMutation) ProductIDs() (ids []int64) {
...
func (m *ProductItemMutation) Fields() []string {
	...
	if m.active_at != nil {
		fields = append(fields, productitem.FieldActiveAt)
	}
	if m.expired_at != nil {
		fields = append(fields, productitem.FieldExpiredAt)
	}
	if m.tag_id != nil {
...
func (m *ProductItemMutation) ClearedFields() []string {
	...
	if m.FieldCleared(productitem.FieldActiveAt) {
		fields = append(fields, productitem.FieldActiveAt)
	}
	if m.FieldCleared(productitem.FieldExpiredAt) {
		fields = append(fields, productitem.FieldExpiredAt)
	}
