...
func (c *ProductClient) QueryItems(_m *Product) *ProductItemQuery {
...
func (c *ProductItemClient) QueryProduct(_m *ProductItem) *ProductQuery {
...
type (
	hooks struct {
		Product, ProductItem []ent.Hook
	}
	inters struct {
		Product, ProductItem []ent.Interceptor
	}
)
