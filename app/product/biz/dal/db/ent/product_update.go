...
// AddItems adds the "items" edges to the ProductItem entity.
func (_u *ProductUpdate) AddItems(v ...*ProductItem) *ProductUpdate {
...
// ClearItems clears all "items" edges to the ProductItem entity.
func (_u *ProductUpdate) ClearItems() *ProductUpdate {
	_u.mutation.ClearItems()
	return _u
}

// RemoveItemIDs removes the "items" edge to ProductItem entities by IDs.
func (_u *ProductUpdate) RemoveItemIDs(ids ...int64) *ProductUpdate {
	_u.mutation.RemoveItemIDs(ids...)
	return _u
}

// RemoveItems removes "items" edges to ProductItem entities.
func (_u *ProductUpdate) RemoveItems(v ...*ProductItem) *ProductUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	...
	if _u.mutation.ItemsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(productitem.FieldID, field.TypeInt64),
			},
		}
...
// AddItems adds the "items" edges to the ProductItem entity.
func (_u *ProductUpdateOne) AddItems(v ...*ProductItem) *ProductUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveItems removes "items" edges to ProductItem entities.
func (_u *ProductUpdateOne) RemoveItems(v ...*ProductItem) *ProductUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
