...
func (_u *ProductUpdate) AddPropertyIDs(ids ...int64) *ProductUpdate {
	_u.mutation.AddPropertyIDs(ids...)
	return _u
}

// AddPropertys adds the "propertys" edges to the ProductProperty entity.
func (_u *ProductUpdate) AddPropertys(v ...*ProductProperty) *ProductUpdate {
...
func (_u *ProductUpdate) ClearPropertys() *ProductUpdate {
	_u.mutation.ClearPropertys()
	return _u
}

// RemovePropertyIDs removes the "propertys" edge to ProductProperty entities by IDs.
func (_u *ProductUpdate) RemovePropertyIDs(ids ...int64) *ProductUpdate {
	_u.mutation.RemovePropertyIDs(ids...)
	return _u
}

// RemovePropertys removes "propertys" edges to ProductProperty entities.
func (_u *ProductUpdate) RemovePropertys(v ...*ProductProperty) *ProductUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ProductUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.PropertysCleared() {
	...
	if nodes := _u.mutation.RemovedPropertysIDs(); len(nodes) > 0 && !_u.mutation.PropertysCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   product.PropertysTable,
	...
	if nodes := _u.mutation.PropertysIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   product.PropertysTable,
...
// AddPropertyIDs adds the "propertys" edge to the ProductProperty entity by IDs.
func (_u *ProductUpdateOne) AddPropertyIDs(ids ...int64) *ProductUpdateOne {
	_u.mutation.AddPropertyIDs(ids...)
	return _u
}

// AddPropertys adds the "propertys" edges to the ProductProperty entity.
func (_u *ProductUpdateOne) AddPropertys(v ...*ProductProperty) *ProductUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPropertys clears all "propertys" edges to the ProductProperty entity.
func (_u *ProductUpdateOne) ClearPropertys() *ProductUpdateOne {
	_u.mutation.ClearPropertys()
	return _u
}

// RemovePropertyIDs removes the "propertys" edge to ProductProperty entities by IDs.
func (_u *ProductUpdateOne) RemovePropertyIDs(ids ...int64) *ProductUpdateOne {
	_u.mutation.RemovePropertyIDs(ids...)
	return _u
}

// RemovePropertys removes "propertys" edges to ProductProperty entities.
func (_u *ProductUpdateOne) RemovePropertys(v ...*ProductProperty) *ProductUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
