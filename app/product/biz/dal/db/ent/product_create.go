...
func (_c *ProductCreate) AddPropertyIDs(ids ...int64) *ProductCreate {
	_c.mutation.AddPropertyIDs(ids...)
	return _c
}

// AddPropertys adds the "propertys" edges to the ProductProperty entity.
func (_c *ProductCreate) AddPropertys(v ...*ProductProperty) *ProductCreate {
...
func (_c *ProductCreate) createSpec() (*Product, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.PropertysIDs(); len(nodes) > 0 {
