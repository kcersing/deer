...
func (_u *OrderUpdate) AddEventbuIDs(ids ...int64) *OrderUpdate {
	_u.mutation.AddEventbuIDs(ids...)
	return _u
}

// AddEventbus adds the "eventbus" edges to the OrderEvents entity.
func (_u *OrderUpdate) AddEventbus(v ...*OrderEvents) *OrderUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddEventbuIDs(ids...)
}
...
// ClearEventbus clears all "eventbus" edges to the OrderEvents entity.
func (_u *OrderUpdate) ClearEventbus() *OrderUpdate {
	_u.mutation.ClearEventbus()
	return _u
}

// RemoveEventbuIDs removes the "eventbus" edge to OrderEvents entities by IDs.
func (_u *OrderUpdate) RemoveEventbuIDs(ids ...int64) *OrderUpdate {
	_u.mutation.RemoveEventbuIDs(ids...)
	return _u
}

// RemoveEventbus removes "eventbus" edges to OrderEvents entities.
func (_u *OrderUpdate) RemoveEventbus(v ...*OrderEvents) *OrderUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveEventbuIDs(ids...)
}
...
func (_u *OrderUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.EventbusCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedEventbusIDs(); len(nodes) > 0 && !_u.mutation.EventbusCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   order.EventbusTable,
	...
	if nodes := _u.mutation.EventbusIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   order.EventbusTable,
...
// AddEventbuIDs adds the "eventbus" edge to the OrderEvents entity by IDs.
func (_u *OrderUpdateOne) AddEventbuIDs(ids ...int64) *OrderUpdateOne {
	_u.mutation.AddEventbuIDs(ids...)
	return _u
}

// AddEventbus adds the "eventbus" edges to the OrderEvents entity.
func (_u *OrderUpdateOne) AddEventbus(v ...*OrderEvents) *OrderUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearEventbus clears all "eventbus" edges to the OrderEvents entity.
func (_u *OrderUpdateOne) ClearEventbus() *OrderUpdateOne {
	_u.mutation.ClearEventbus()
	return _u
}

// RemoveEventbuIDs removes the "eventbus" edge to OrderEvents entities by IDs.
func (_u *OrderUpdateOne) RemoveEventbuIDs(ids ...int64) *OrderUpdateOne {
	_u.mutation.RemoveEventbuIDs(ids...)
	return _u
}

// RemoveEventbus removes "eventbus" edges to OrderEvents entities.
func (_u *OrderUpdateOne) RemoveEventbus(v ...*OrderEvents) *OrderUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
