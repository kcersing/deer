...
const (
	...
	EdgePay = "pay"
	// EdgeEventbus holds the string denoting the eventbus edge name in mutations.
	EdgeEventbus = "eventbus"
	...
	PayColumn = "order_id"
	// EventbusTable is the table that holds the eventbus relation/edge.
	EventbusTable = "order_events"
	// EventbusInverseTable is the table name for the OrderEvents entity.
	// It exists in this package in order to avoid circular dependency with the "orderevents" package.
	EventbusInverseTable = "order_events"
	// EventbusColumn is the table column denoting the eventbus relation/edge.
	EventbusColumn = "aggregate_id"
...
// ByEventbusCount orders the results by eventbus count.
func ByEventbusCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newEventbusStep(), opts...)
	}
}

// ByEventbus orders the results by eventbus terms.
func ByEventbus(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newEventbusStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newEventbusStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(EventbusInverseTable, FieldID),
