...
export async function getRoleList(params: {
  ...
  return request<API.RoleListResp>('/service/role/list', {
    method: 'POST', headers: {
      ...headers,
    }, data: {
...
export async function getRoleTree() {
  return request<API.TreeResp>('/service/role/tree', {
    method: 'POST', headers: {
      ...headers,
    },
  });
...
export async function deleteRole(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role/delete', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
...
export async function updateRole(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role/update', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
...
export async function createRole(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role/create', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
...
export async function getRole(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
...
export async function CreateRoleMenu(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role/create/menu', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
...
export async function CreateRoleApi(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role/create/api', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
...
export async function GetRoleApi(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role/api', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
...
export async function GetRoleMenu(options?: { [key: string]: any }) {
  return request<API.TreeResp>('/service/role/menu', {
    method: 'POST', headers: {
      ...headers,
    }, ...(options || {}),
  });
