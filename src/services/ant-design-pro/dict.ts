...
export async function UpdateDict(options?: { [key: string]: any }) {
  return request<API.NoticeIconList>('/service/dict/update', {
    method: 'PSOT',
    headers: {
      ...headers,
    },
...
export async function DeleteDict(options?: { [key: string]: any }) {
  return request<API.NoticeIconList>('/service/dict/delete', {
    method: 'PSOT',
    headers: {
      ...headers,
    },
...
export async function getDictList(options?: { [key: string]: any }) {
  return request<API.NoticeIconList>('/service/dict/list', {
    method: 'POST',
    headers: {
      ...headers,
    },
...
export async function CreateDictht(options?: { [key: string]: any }) {
  return request<API.NoticeIconList>('/service/dict/dictht/create', {
    method: 'PSOT',
    headers: {
      ...headers,
    },
...
export async function UpdateDictht(options?: { [key: string]: any }) {
  return request<API.NoticeIconList>('/service/dict/dictht/update', {
    method: 'PSOT',
    headers: {
      ...headers,
    },
...
export async function DeleteDictht(options?: { [key: string]: any }) {
  return request<API.NoticeIconList>('/service/dict/dictht/delete', {
    method: 'PSOT',
    headers: {
      ...headers,
    },
...
export async function DicthtList(options?: { [key: string]: any }) {
  return request<API.NoticeIconList>('/service/dict/dictht/list', {
    method: 'POST',
    headers: {
      ...headers,
    },
